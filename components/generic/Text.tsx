...
const HeadingTwoComponent = UnstyledText.withComponent("h2");
const HeadingThreeComponent = UnstyledText.withComponent("h3");
const HeadingFourComponent = UnstyledText.withComponent("h4");
